...
public class EspinardoDoWhile {
    ...
    //ALGORITMO
    //Creo el bucle de preguntas usando Do While. La hora inicial es indiferente, ya que la primera comprobación del bucle se hace al terminar la primera ronda de preguntas
    do
    {
